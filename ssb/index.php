...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/media.css" async>
		...
		<section id="features">
			<div class="content">
				...
				<div id="highlights" class="flex flex-wrap flex-center col3 center">
					...
					<!--
					<div class="highlight">
						<a href="https://www.youtube.com/watch?v=nXhxGZAD8Jo" class="highlight-img link-nodeco link-img" style=""></a>
						<h1 class="body body-header bold">Watch <span class="col-accent">our video</span> to learn more</h1>

						<p class="body body-em">Take a closer look at some of our key features in this short introduction video.</p>
					</div>
					-->
				</div>
				...
				<div class="center" style="margin-bottom: 2em;">
					<iframe id="youtube-video" src="https://www.youtube.com/embed/nXhxGZAD8Jo" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</section>
